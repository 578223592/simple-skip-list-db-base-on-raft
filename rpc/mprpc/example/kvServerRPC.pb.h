...
inline ::PROTOBUF_NAMESPACE_ID::int32 GetArgs::_internal_clientid() const {
  return clientid_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 GetArgs::clientid() const {
  // @@protoc_insertion_point(field_get:mprrpc.GetArgs.ClientId)
  return _internal_clientid();
}
inline void GetArgs::_internal_set_clientid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  clientid_ = value;
}
inline void GetArgs::set_clientid(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 PutAppendArgs::_internal_clientid() const {
  return clientid_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 PutAppendArgs::clientid() const {
  // @@protoc_insertion_point(field_get:mprrpc.PutAppendArgs.ClientId)
  return _internal_clientid();
}
inline void PutAppendArgs::_internal_set_clientid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  clientid_ = value;
}
inline void PutAppendArgs::set_clientid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_clientid(value);
